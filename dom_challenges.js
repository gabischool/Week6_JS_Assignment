...
export function displayArticles(category) {
  ...
  news_cards.append(
    article_images, // img
    conten_container // div-news content
  );

  conten_container.append(
    featured_label, // label-span
    news_title, // news title
    news_date, // div-news date
    news_excerpt, // p-news-excerpt
    news_tags // span-news-tags
  );
...
footer_div.classList.add("bottom");
const footer_text = document.createElement("p");
footer_text.textContent = `Copyright © 2025 GabiNews`;
