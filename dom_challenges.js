...
function displayArticles(category) {
  ...
  const featuredImage = document.createElement("image");
  featuredImage.className = "news-image";
  ...
  featuredDate.className = "featured-date";
  const featuredExcerpt = document.createElement("p");
  featuredDate.className = "featured-excerpt";

  // connect the h2 and p to the div
  featuredContent.appendChild(featuredTitle);
  featuredContent.appendChild(featuredDate);
  featuredContent.appendChild(featuredExcerpt);
