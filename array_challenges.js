...
const movie_over_view = movies.map((mov) => {
  const overView = `${mov.title} - ${mov.rating}/10`;
...
// ✍️ Solve it here ✍️
const highly_rated_movies = movies.filter((mov) => mov.rating >= 8.0);
console.log(highly_rated_movies);
