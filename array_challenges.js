...
const movies = [
  ...
  */
  ...
  // ✍️ Solve it here ✍️
  const movieTitle = movies.map((newMovie)=> {
    return (`Title: ${newMovie.title}- Rating: ${newMovie.rating}/10`)
  })
 ...
 const movieRating = movies.filter((newRating)=> {
  return newRating.rating >= 8.0
